    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='programs', to='institutions.faculty')),
        ...
        migrations.AddIndex(
            model_name='program',
            index=models.Index(fields=['institution', 'degree_level'], name='programs_pr_institu_c8b548_idx'),
        ),
        migrations.AddConstraint(
            model_name='program',
            constraint=models.UniqueConstraint(fields=('institution', 'slug'), name='unique_program_institution_slug'),
        ),
        migrations.AddConstraint(
            model_name='course',
