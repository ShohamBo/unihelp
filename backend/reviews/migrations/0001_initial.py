...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snippets', to='reviews.reviewsource'),
        ),
        migrations.CreateModel(
            name='RawScrape',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='reviewsnippet',
            constraint=models.UniqueConstraint(fields=('source', 'external_id'), name='unique_snippet_source_external_id'),
        ),
        migrations.AddIndex(
